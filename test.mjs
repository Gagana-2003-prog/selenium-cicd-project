  ...
  try {
    ...
    try {
      ...
      if (title.includes("Swag Labs")) {
        console.log("   ✅ PASSED — Website loaded! Title:", title);
        passed++;
      } else {
    ...
    try {
      ...
      console.log("   ✅ PASSED — All form elements found!");
      passed++;
    ...
    try {
      ...
      if (products.length === 6) {
        ...
        console.log(
          "   ❌ FAILED — Expected 6 products, but found",
          products.length
        );
        failed++;
      }
    ...
    try {
      ...
      if (!url.includes("inventory")) {
        ...
        throw new Error("Still on inventory page after logout");
      }
